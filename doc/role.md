...
**PATH:**  role.metadata.annotations
...
## clusterName	\<string\>
**PATH:**  role.metadata.clusterName
...
**PATH:**  role.metadata.creationTimestamp
...
**PATH:**  role.metadata.deletionGracePeriodSeconds
...
**PATH:**  role.metadata.deletionTimestamp
...
## generateName	\<string\>
**PATH:**  role.metadata.generateName
...
## generation	\<integer\>
**PATH:**  role.metadata.generation

     A sequence number representing a specific generation of the desired state.
     Populated by the system. Read-only.

## initializers \<Object\>
**PATH:**  role.metadata.initializers
...
### pending \<[]Object\>
**PATH:**  role.metadata.initializers.pending
...
### result \<Object\>
**PATH:**  role.metadata.initializers.result
...
#### apiVersion	\<string\>
**PATH:**  role.metadata.initializers.result.apiVersion
...
#### code	\<integer\>
**PATH:**  role.metadata.initializers.result.code

     Suggested HTTP return code for this status, 0 if not set.

#### details \<Object\>
**PATH:**  role.metadata.initializers.result.details
...
##### causes \<[]Object\>
**PATH:**  role.metadata.initializers.result.details.causes
...
###### field	\<string\>
**PATH:**  role.metadata.initializers.result.details.causes.field
...
###### message	\<string\>
**PATH:**  role.metadata.initializers.result.details.causes.message
...
##### group	\<string\>
**PATH:**  role.metadata.initializers.result.details.group

     The group attribute of the resource associated with the status
     StatusReason.

##### kind	\<string\>
**PATH:**  role.metadata.initializers.result.details.kind
...
##### name	\<string\>
**PATH:**  role.metadata.initializers.result.details.name

     The name attribute of the resource associated with the status StatusReason
     (when there is a single name which can be described).

##### retryAfterSeconds	\<integer\>
**PATH:**  role.metadata.initializers.result.details.retryAfterSeconds
...
#### kind	\<string\>
**PATH:**  role.metadata.initializers.result.kind
...
#### message	\<string\>
**PATH:**  role.metadata.initializers.result.message

     A human-readable description of the status of this operation.

#### metadata \<Object\>
**PATH:**  role.metadata.initializers.result.metadata
...
##### continue	\<string\>
**PATH:**  role.metadata.initializers.result.metadata.continue
...
**PATH:**  role.metadata.initializers.result.metadata.resourceVersion
...
#### reason	\<string\>
**PATH:**  role.metadata.initializers.result.reason
...
**PATH:**  role.metadata.managedFields
...
### apiVersion	\<string\>
**PATH:**  role.metadata.managedFields.apiVersion
...
### manager	\<string\>
**PATH:**  role.metadata.managedFields.manager

     Manager is an identifier of the workflow managing these fields.

### operation	\<string\>
**PATH:**  role.metadata.managedFields.operation
...
**PATH:**  role.metadata.ownerReferences
...
**PATH:**  role.metadata.ownerReferences.apiVersion

     API version of the referent.

### blockOwnerDeletion	\<boolean\>
**PATH:**  role.metadata.ownerReferences.blockOwnerDeletion
...
### controller	\<boolean\>
**PATH:**  role.metadata.ownerReferences.controller

     If true, this reference points to the managing controller.

### kind	\<string\> -required-
**PATH:**  role.metadata.ownerReferences.kind

     Kind of the referent. More info:
     https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds

### name	\<string\> -required-
**PATH:**  role.metadata.ownerReferences.name
...
## resourceVersion	\<string\>
**PATH:**  role.metadata.resourceVersion
...
**PATH:**  role.rules.nonResourceURLs
...
**PATH:**  role.rules.resourceNames

     ResourceNames is an optional white list of names that the rule applies to.
     An empty set means that everything is allowed.

## resources	\<[]string\>
**PATH:**  role.rules.resources
