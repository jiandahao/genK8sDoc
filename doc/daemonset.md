...
##### tty	\<boolean\>
**PATH:**  daemonset.spec.template.spec.containers.tty

     Whether this container should allocate a TTY for itself, also requires
     'stdin' to be true. Default is false.

##### volumeDevices \<[]Object\>
**PATH:**  daemonset.spec.template.spec.containers.volumeDevices
...
**PATH:**  daemonset.spec.template.spec.containers.volumeDevices.devicePath
...
##### volumeMounts \<[]Object\>
**PATH:**  daemonset.spec.template.spec.containers.volumeMounts
...
**PATH:**  daemonset.spec.template.spec.containers.volumeMounts.mountPath

     Path within the container at which the volume should be mounted. Must not
     contain ':'.

###### mountPropagation	\<string\>
**PATH:**  daemonset.spec.template.spec.containers.volumeMounts.mountPropagation
...
###### name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.containers.volumeMounts.name

     This must match the Name of a Volume.

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.containers.volumeMounts.readOnly

     Mounted read-only if true, read-write otherwise (false or unspecified).
     Defaults to false.

###### subPath	\<string\>
**PATH:**  daemonset.spec.template.spec.containers.volumeMounts.subPath
...
#### dnsConfig \<Object\>
**PATH:**  daemonset.spec.template.spec.dnsConfig
...
##### nameservers	\<[]string\>
**PATH:**  daemonset.spec.template.spec.dnsConfig.nameservers
...
##### options \<[]Object\>
**PATH:**  daemonset.spec.template.spec.dnsConfig.options
...
###### name	\<string\>
**PATH:**  daemonset.spec.template.spec.dnsConfig.options.name
...
#### dnsPolicy	\<string\>
**PATH:**  daemonset.spec.template.spec.dnsPolicy
...
**PATH:**  daemonset.spec.template.spec.enableServiceLinks
...
#### hostAliases \<[]Object\>
**PATH:**  daemonset.spec.template.spec.hostAliases
...
##### hostnames	\<[]string\>
**PATH:**  daemonset.spec.template.spec.hostAliases.hostnames
...
#### hostIPC	\<boolean\>
**PATH:**  daemonset.spec.template.spec.hostIPC

     Use the host's ipc namespace. Optional: Default to false.

#### hostNetwork	\<boolean\>
**PATH:**  daemonset.spec.template.spec.hostNetwork
...
#### hostPID	\<boolean\>
**PATH:**  daemonset.spec.template.spec.hostPID

     Use the host's pid namespace. Optional: Default to false.

#### hostname	\<string\>
**PATH:**  daemonset.spec.template.spec.hostname

     Specifies the hostname of the Pod If not specified, the pod's hostname will
     be set to a system-defined value.

#### imagePullSecrets \<[]Object\>
**PATH:**  daemonset.spec.template.spec.imagePullSecrets
...
**PATH:**  daemonset.spec.template.spec.initContainers
...
##### args	\<[]string\>
**PATH:**  daemonset.spec.template.spec.initContainers.args
...
##### command	\<[]string\>
**PATH:**  daemonset.spec.template.spec.initContainers.command
...
##### env \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.env
...
###### name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.env.name

     Name of the environment variable. Must be a C_IDENTIFIER.

###### value	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.value
...
###### valueFrom \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom
...
- configMapKeyRef \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.configMapKeyRef
...
- key	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.configMapKeyRef.key

     The key to select.

- name	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.configMapKeyRef.name
...
- fieldRef \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.fieldRef
...
- apiVersion	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.fieldRef.apiVersion
...
- resourceFieldRef \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.resourceFieldRef
...
- containerName	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.resourceFieldRef.containerName

     Container name: required for volumes, optional for env vars

- divisor	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.resourceFieldRef.divisor
...
- secretKeyRef \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.secretKeyRef
...
- key	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.secretKeyRef.key

     The key of the secret to select from. Must be a valid secret key.

- name	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.env.valueFrom.secretKeyRef.name
...
##### envFrom \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.envFrom
...
###### configMapRef \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.envFrom.configMapRef
...
- name	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.envFrom.configMapRef.name
...
###### prefix	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.envFrom.prefix

     An optional identifier to prepend to each key in the ConfigMap. Must be a
     C_IDENTIFIER.

###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.envFrom.secretRef
...
- name	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.envFrom.secretRef.name
...
##### image	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.image
...
##### imagePullPolicy	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.imagePullPolicy
...
##### lifecycle \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle
...
###### postStart \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart
...
- exec \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.exec
...
- httpGet \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.httpGet
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.httpGet.host

     Host name to connect to, defaults to the pod IP. You probably want to set
     "Host" in httpHeaders instead.

- httpHeaders \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.httpGet.httpHeaders
...
- name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.httpGet.httpHeaders.name
...
- path	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.httpGet.path

     Path to access on the HTTP server.

- port	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.httpGet.port
...
- tcpSocket \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.tcpSocket
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.postStart.tcpSocket.host
...
###### preStop \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop
...
- exec \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.exec
...
- httpGet \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.httpGet
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.httpGet.host

     Host name to connect to, defaults to the pod IP. You probably want to set
     "Host" in httpHeaders instead.

- httpHeaders \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.httpGet.httpHeaders
...
- name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.httpGet.httpHeaders.name
...
- path	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.httpGet.path

     Path to access on the HTTP server.

- port	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.httpGet.port
...
- tcpSocket \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.tcpSocket
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.lifecycle.preStop.tcpSocket.host
...
##### livenessProbe \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe
...
###### exec \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.exec
...
###### failureThreshold	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.failureThreshold

     Minimum consecutive failures for the probe to be considered failed after
     having succeeded. Defaults to 3. Minimum value is 1.

###### httpGet \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.httpGet
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.httpGet.host

     Host name to connect to, defaults to the pod IP. You probably want to set
     "Host" in httpHeaders instead.

- httpHeaders \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.httpGet.httpHeaders
...
- name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.httpGet.httpHeaders.name
...
- path	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.httpGet.path

     Path to access on the HTTP server.

- port	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.httpGet.port
...
###### initialDelaySeconds	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.initialDelaySeconds
...
###### periodSeconds	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.periodSeconds

     How often (in seconds) to perform the probe. Default to 10 seconds. Minimum
     value is 1.

###### successThreshold	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.successThreshold
...
###### tcpSocket \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.tcpSocket
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.livenessProbe.tcpSocket.host
...
##### name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.name

     Name of the container specified as a DNS_LABEL. Each container in a pod
     must have a unique name (DNS_LABEL). Cannot be updated.

##### ports \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.ports
...
###### containerPort	\<integer\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.ports.containerPort

     Number of port to expose on the pod's IP address. This must be a valid port
     number, 0 < x < 65536.

###### hostIP	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.ports.hostIP

     What host IP to bind the external port to.

###### hostPort	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.ports.hostPort
...
###### name	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.ports.name
...
##### readinessProbe \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe
...
###### exec \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.exec
...
###### failureThreshold	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.failureThreshold

     Minimum consecutive failures for the probe to be considered failed after
     having succeeded. Defaults to 3. Minimum value is 1.

###### httpGet \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.httpGet
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.httpGet.host

     Host name to connect to, defaults to the pod IP. You probably want to set
     "Host" in httpHeaders instead.

- httpHeaders \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.httpGet.httpHeaders
...
- name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.httpGet.httpHeaders.name
...
- path	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.httpGet.path

     Path to access on the HTTP server.

- port	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.httpGet.port
...
###### initialDelaySeconds	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.initialDelaySeconds
...
###### periodSeconds	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.periodSeconds

     How often (in seconds) to perform the probe. Default to 10 seconds. Minimum
     value is 1.

###### successThreshold	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.successThreshold
...
###### tcpSocket \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.tcpSocket
...
- host	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.readinessProbe.tcpSocket.host
...
##### resources \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.resources
...
###### limits	\<map[string]string\>
**PATH:**  daemonset.spec.template.spec.initContainers.resources.limits
...
##### securityContext \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext
...
###### allowPrivilegeEscalation	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.allowPrivilegeEscalation
...
###### capabilities \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.capabilities
...
- add	\<[]string\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.capabilities.add
...
###### privileged	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.privileged

     Run container in privileged mode. Processes in privileged containers are
     essentially equivalent to root on the host. Defaults to false.

###### procMount	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.procMount
...
###### readOnlyRootFilesystem	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.readOnlyRootFilesystem

     Whether this container has a read-only root filesystem. Default is false.

###### runAsGroup	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.runAsGroup
...
###### runAsNonRoot	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.runAsNonRoot
...
###### runAsUser	\<integer\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.runAsUser
...
###### seLinuxOptions \<Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.seLinuxOptions
...
- level	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.seLinuxOptions.level

     Level is SELinux level label that applies to the container.

- role	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.seLinuxOptions.role

     Role is a SELinux role label that applies to the container.

- type	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.securityContext.seLinuxOptions.type
...
##### stdin	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.stdin
...
##### stdinOnce	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.stdinOnce
...
##### terminationMessagePath	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.terminationMessagePath
...
##### terminationMessagePolicy	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.terminationMessagePolicy
...
##### tty	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.tty

     Whether this container should allocate a TTY for itself, also requires
     'stdin' to be true. Default is false.

##### volumeDevices \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.volumeDevices
...
###### devicePath	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.volumeDevices.devicePath
...
##### volumeMounts \<[]Object\>
**PATH:**  daemonset.spec.template.spec.initContainers.volumeMounts
...
###### mountPath	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.volumeMounts.mountPath

     Path within the container at which the volume should be mounted. Must not
     contain ':'.

###### mountPropagation	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.volumeMounts.mountPropagation
...
###### name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.initContainers.volumeMounts.name

     This must match the Name of a Volume.

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.initContainers.volumeMounts.readOnly

     Mounted read-only if true, read-write otherwise (false or unspecified).
     Defaults to false.

###### subPath	\<string\>
**PATH:**  daemonset.spec.template.spec.initContainers.volumeMounts.subPath
...
#### nodeName	\<string\>
**PATH:**  daemonset.spec.template.spec.nodeName
...
**PATH:**  daemonset.spec.template.spec.nodeSelector
...
#### priority	\<integer\>
**PATH:**  daemonset.spec.template.spec.priority
...
**PATH:**  daemonset.spec.template.spec.priorityClassName
...
**PATH:**  daemonset.spec.template.spec.readinessGates
...
**PATH:**  daemonset.spec.template.spec.restartPolicy
...
**PATH:**  daemonset.spec.template.spec.runtimeClassName
...
**PATH:**  daemonset.spec.template.spec.schedulerName

     If specified, the pod will be dispatched by specified scheduler. If not
     specified, the pod will be dispatched by default scheduler.

#### securityContext \<Object\>
**PATH:**  daemonset.spec.template.spec.securityContext
...
##### fsGroup	\<integer\>
**PATH:**  daemonset.spec.template.spec.securityContext.fsGroup
...
##### runAsGroup	\<integer\>
**PATH:**  daemonset.spec.template.spec.securityContext.runAsGroup
...
##### runAsNonRoot	\<boolean\>
**PATH:**  daemonset.spec.template.spec.securityContext.runAsNonRoot
...
##### runAsUser	\<integer\>
**PATH:**  daemonset.spec.template.spec.securityContext.runAsUser
...
##### seLinuxOptions \<Object\>
**PATH:**  daemonset.spec.template.spec.securityContext.seLinuxOptions
...
###### level	\<string\>
**PATH:**  daemonset.spec.template.spec.securityContext.seLinuxOptions.level

     Level is SELinux level label that applies to the container.

###### role	\<string\>
**PATH:**  daemonset.spec.template.spec.securityContext.seLinuxOptions.role

     Role is a SELinux role label that applies to the container.

###### type	\<string\>
**PATH:**  daemonset.spec.template.spec.securityContext.seLinuxOptions.type
...
##### sysctls \<[]Object\>
**PATH:**  daemonset.spec.template.spec.securityContext.sysctls
...
###### name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.securityContext.sysctls.name
...
**PATH:**  daemonset.spec.template.spec.serviceAccount

     DeprecatedServiceAccount is a depreciated alias for ServiceAccountName.
     Deprecated: Use serviceAccountName instead.

#### serviceAccountName	\<string\>
**PATH:**  daemonset.spec.template.spec.serviceAccountName
...
**PATH:**  daemonset.spec.template.spec.shareProcessNamespace
...
#### subdomain	\<string\>
**PATH:**  daemonset.spec.template.spec.subdomain
...
**PATH:**  daemonset.spec.template.spec.terminationGracePeriodSeconds
...
#### tolerations \<[]Object\>
**PATH:**  daemonset.spec.template.spec.tolerations
...
##### effect	\<string\>
**PATH:**  daemonset.spec.template.spec.tolerations.effect
...
##### key	\<string\>
**PATH:**  daemonset.spec.template.spec.tolerations.key
...
##### operator	\<string\>
**PATH:**  daemonset.spec.template.spec.tolerations.operator
...
**PATH:**  daemonset.spec.template.spec.tolerations.tolerationSeconds
...
#### volumes \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes
...
**PATH:**  daemonset.spec.template.spec.volumes.awsElasticBlockStore
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.awsElasticBlockStore.fsType
...
###### partition	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.awsElasticBlockStore.partition
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.awsElasticBlockStore.readOnly
...
##### azureDisk \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.azureDisk
...
###### cachingMode	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.azureDisk.cachingMode

     Host Caching mode: None, Read Only, Read Write.

###### diskName	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.azureDisk.diskName

     The Name of the data disk in the blob storage

###### diskURI	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.azureDisk.diskURI

     The URI the data disk in the blob storage

###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.azureDisk.fsType
...
###### kind	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.azureDisk.kind
...
##### azureFile \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.azureFile
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.azureFile.readOnly

     Defaults to false (read/write). ReadOnly here will force the ReadOnly
     setting in VolumeMounts.

###### secretName	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.azureFile.secretName
...
##### cephfs \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.cephfs
...
**PATH:**  daemonset.spec.template.spec.volumes.cephfs.monitors

     Required: Monitors is a collection of Ceph monitors More info:
     https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it

###### path	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.cephfs.path

     Optional: Used as the mounted root, rather than the full Ceph tree, default
     is /

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.cephfs.readOnly
...
###### secretFile	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.cephfs.secretFile
...
###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.cephfs.secretRef
...
##### cinder \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.cinder
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.cinder.fsType
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.cinder.readOnly
...
###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.cinder.secretRef
...
##### configMap \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.configMap
...
###### defaultMode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.configMap.defaultMode
...
###### items \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.configMap.items
...
- key	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.configMap.items.key

     The key to project.

- mode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.configMap.items.mode
...
###### name	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.configMap.name
...
##### csi \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.csi
...
**PATH:**  daemonset.spec.template.spec.volumes.csi.driver
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.csi.fsType
...
**PATH:**  daemonset.spec.template.spec.volumes.csi.nodePublishSecretRef
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.csi.readOnly
...
##### downwardAPI \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI
...
###### defaultMode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.defaultMode
...
###### items \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items
...
- fieldRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.fieldRef
...
- apiVersion	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.fieldRef.apiVersion
...
- mode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.mode
...
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.path
...
- resourceFieldRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.resourceFieldRef
...
- containerName	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.resourceFieldRef.containerName

     Container name: required for volumes, optional for env vars

- divisor	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.downwardAPI.items.resourceFieldRef.divisor
...
##### emptyDir \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.emptyDir
...
###### medium	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.emptyDir.medium
...
##### fc \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.fc
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.fc.fsType
...
###### lun	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.fc.lun

     Optional: FC target lun number

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.fc.readOnly

     Optional: Defaults to false (read/write). ReadOnly here will force the
     ReadOnly setting in VolumeMounts.

###### targetWWNs	\<[]string\>
**PATH:**  daemonset.spec.template.spec.volumes.fc.targetWWNs
...
##### flexVolume \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.flexVolume
...
###### driver	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.flexVolume.driver

     Driver is the name of the driver to use for this volume.

###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.flexVolume.fsType
...
**PATH:**  daemonset.spec.template.spec.volumes.flexVolume.options

     Optional: Extra command options if any.

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.flexVolume.readOnly

     Optional: Defaults to false (read/write). ReadOnly here will force the
     ReadOnly setting in VolumeMounts.

###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.flexVolume.secretRef
...
##### flocker \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.flocker
...
###### datasetName	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.flocker.datasetName
...
**PATH:**  daemonset.spec.template.spec.volumes.gcePersistentDisk
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.gcePersistentDisk.fsType
...
###### partition	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.gcePersistentDisk.partition
...
**PATH:**  daemonset.spec.template.spec.volumes.gcePersistentDisk.pdName
...
##### gitRepo \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.gitRepo
...
###### directory	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.gitRepo.directory
...
**PATH:**  daemonset.spec.template.spec.volumes.gitRepo.repository
...
##### glusterfs \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.glusterfs
...
**PATH:**  daemonset.spec.template.spec.volumes.glusterfs.endpoints
...
###### path	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.glusterfs.path
...
##### hostPath \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.hostPath
...
###### path	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.hostPath.path
...
##### iscsi \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi
...
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.chapAuthDiscovery

     whether support iSCSI Discovery CHAP authentication

###### chapAuthSession	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.chapAuthSession

     whether support iSCSI Session CHAP authentication

###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.fsType
...
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.initiatorName
...
###### iqn	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.iqn

     Target iSCSI Qualified Name.

###### iscsiInterface	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.iscsiInterface

     iSCSI Interface Name that uses an iSCSI transport. Defaults to 'default'
     (tcp).

###### lun	\<integer\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.lun

     iSCSI Target Lun number.

###### portals	\<[]string\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.portals
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.readOnly

     ReadOnly here will force the ReadOnly setting in VolumeMounts. Defaults to
     false.

###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.iscsi.secretRef
...
##### name	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.name

     Volume's name. Must be a DNS_LABEL and unique within the pod. More info:
     https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names

##### nfs \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.nfs
...
###### path	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.nfs.path

     Path that is exported by the NFS server. More info:
     https://kubernetes.io/docs/concepts/storage/volumes#nfs

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.nfs.readOnly
...
**PATH:**  daemonset.spec.template.spec.volumes.persistentVolumeClaim
...
**PATH:**  daemonset.spec.template.spec.volumes.persistentVolumeClaim.claimName
...
**PATH:**  daemonset.spec.template.spec.volumes.photonPersistentDisk
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.photonPersistentDisk.fsType
...
**PATH:**  daemonset.spec.template.spec.volumes.portworxVolume
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.portworxVolume.fsType
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.portworxVolume.readOnly
...
##### projected \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected
...
###### defaultMode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.defaultMode
...
###### sources \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources
...
- configMap \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.configMap
...
- items \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.configMap.items
...
- key	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.configMap.items.key

     The key to project.

- mode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.configMap.items.mode
...
- name	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.configMap.name
...
- downwardAPI \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI
...
- items \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items
...
- fieldRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.fieldRef
...
- apiVersion	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.fieldRef.apiVersion
...
- mode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.mode
...
- path	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.path
...
- resourceFieldRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.resourceFieldRef
...
- containerName	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.resourceFieldRef.containerName

     Container name: required for volumes, optional for env vars

- divisor	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.downwardAPI.items.resourceFieldRef.divisor
...
- secret \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.secret
...
- items \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.secret.items
...
- key	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.secret.items.key

     The key to project.

- mode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.secret.items.mode
...
- name	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.secret.name
...
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.serviceAccountToken
...
- audience	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.serviceAccountToken.audience
...
**PATH:**  daemonset.spec.template.spec.volumes.projected.sources.serviceAccountToken.expirationSeconds
...
##### quobyte \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.quobyte
...
###### group	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.quobyte.group

     Group to map volume access to Default is no group

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.quobyte.readOnly

     ReadOnly here will force the Quobyte volume to be mounted with read-only
     permissions. Defaults to false.

###### registry	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.quobyte.registry
...
###### tenant	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.quobyte.tenant
...
###### user	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.quobyte.user
...
##### rbd \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.rbd
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.rbd.fsType
...
**PATH:**  daemonset.spec.template.spec.volumes.rbd.image

     The rados image name. More info:
     https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it

###### keyring	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.rbd.keyring
...
###### monitors	\<[]string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.rbd.monitors

     A collection of Ceph monitors. More info:
     https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it

###### pool	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.rbd.pool

     The rados pool name. Default is rbd. More info:
     https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.rbd.readOnly
...
###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.rbd.secretRef
...
##### scaleIO \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.fsType

     Filesystem type to mount. Must be a filesystem type supported by the host
     operating system. Ex. "ext4", "xfs", "ntfs". Default is "xfs".

###### gateway	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.gateway

     The host address of the ScaleIO API Gateway.

###### protectionDomain	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.protectionDomain

     The name of the ScaleIO Protection Domain for the configured storage.

###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.readOnly

     Defaults to false (read/write). ReadOnly here will force the ReadOnly
     setting in VolumeMounts.

###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.secretRef
...
###### sslEnabled	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.sslEnabled

     Flag to enable/disable SSL communication with Gateway, default false

###### storageMode	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.storageMode

     Indicates whether the storage for a volume should be ThickProvisioned or
     ThinProvisioned. Default is ThinProvisioned.

###### storagePool	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.storagePool

     The ScaleIO Storage Pool associated with the protection domain.

###### system	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.scaleIO.system
...
##### secret \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.secret
...
###### defaultMode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.secret.defaultMode
...
###### items \<[]Object\>
**PATH:**  daemonset.spec.template.spec.volumes.secret.items
...
- key	\<string\> -required-
**PATH:**  daemonset.spec.template.spec.volumes.secret.items.key

     The key to project.

- mode	\<integer\>
**PATH:**  daemonset.spec.template.spec.volumes.secret.items.mode
...
###### optional	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.secret.optional
...
##### storageos \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.storageos
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.storageos.fsType
...
###### readOnly	\<boolean\>
**PATH:**  daemonset.spec.template.spec.volumes.storageos.readOnly

     Defaults to false (read/write). ReadOnly here will force the ReadOnly
     setting in VolumeMounts.

###### secretRef \<Object\>
**PATH:**  daemonset.spec.template.spec.volumes.storageos.secretRef
...
###### volumeName	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.storageos.volumeName
...
**PATH:**  daemonset.spec.template.spec.volumes.vsphereVolume
...
###### fsType	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.vsphereVolume.fsType
...
**PATH:**  daemonset.spec.template.spec.volumes.vsphereVolume.storagePolicyID

     Storage Policy Based Management (SPBM) profile ID associated with the
     StoragePolicyName.

###### storagePolicyName	\<string\>
**PATH:**  daemonset.spec.template.spec.volumes.vsphereVolume.storagePolicyName
...
**PATH:**  daemonset.status.conditions.lastTransitionTime

     Last time the condition transitioned from one status to another.

### message	\<string\>
**PATH:**  daemonset.status.conditions.message

     A human readable message indicating details about the transition.

### reason	\<string\>
**PATH:**  daemonset.status.conditions.reason

     The reason for the condition's last transition.

### status	\<string\> -required-
**PATH:**  daemonset.status.conditions.status
...
**PATH:**  daemonset.status.currentNumberScheduled
...
**PATH:**  daemonset.status.desiredNumberScheduled
...
**PATH:**  daemonset.status.numberMisscheduled
...
**PATH:**  daemonset.status.numberReady
